...
oot_channel_id_list = [
    ...
    "757815090815696996",#swagbucks-answer
]
...
class Bot(discord.Client):
    ...
    def __init__(self, answer_scores):
        ...
        # embed creation
        self.embed=discord.Embed(title="**__ALPHA TRIVIA | PRO__**", description="**Web Searching** :spy:")
        ...
        self.embed.set_footer(text=f"//SIMBHA//#3664",\
    ...
    async def on_ready(self):
        ...
        await self.change_presence(activity=discord.Game(name='Trivia with //SIMBHA//#3664||*help'))
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NzU1NjkzODE5MDcyMzQ4MTcx.X2HAtg.h6ioccm_It-zXha6i18IvYKv8zs'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('NzU1OTg3OTM5NDE4NDM5NzAy.X2LSog.R9Lu2zctSn8UyQEp9FBAHxitx5U',
                                   bot=False))
    loop.run_forever()
